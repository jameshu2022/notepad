...
function createUsers(cb) {
    async.series([
        function(callback) {
            userCreate('superman', 'kansas', callback);
        },
        function(callback) {
            userCreate('green lantern', 'lanterncorpsrocks', callback);
        },
        function(callback) {
            userCreate('wonder woman', 'gggonext', callback);
        },
        function(callback) {
            userCreate('clown555', 'imok', callback);
        },
        function(callback) {
            userCreate('supergood', 'superbad', callback);
        }
        ],
        // optional callback
        cb);
